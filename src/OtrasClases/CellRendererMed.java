...
public class CellRendererMed extends DefaultTableCellRenderer implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if(String.valueOf(table.getValueAt(row,7)).equals("1")){
            Color color = new Color(235, 86, 72); 
           setBackground(color);
        }
        return this;
    }
