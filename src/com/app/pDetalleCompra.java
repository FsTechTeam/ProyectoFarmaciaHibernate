 ...
 * @author Geek
 */
public class pDetalleCompra extends javax.swing.JDialog {

    /**
     * Creates new form pDetalle
     */
    int idCompra;
    public pDetalleCompra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        hibernateSession();
    ...
    public pDetalleCompra(java.awt.Frame parent, boolean modal, int idCompra) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
    ...
    public void cargarDatos(){
        Tablemodel();
        List<CompraDet> vd = (List<CompraDet>)st.createQuery("From CompraDet").list();
        for(CompraDet detalleCompra:vd){
            int idCp = detalleCompra.getCabecera().getNum();
            if (idCp==idCompra) {
                model.addRow(new Object[]{ detalleCompra.getArticulo().getDes()+" "+ detalleCompra.getArticulo().getTipo().getDes(), detalleCompra.getCantidad(), new java.text.DecimalFormat("Q #,##0.00").format(Double.valueOf(detalleCompra.getImporte()))});
                String fecha = retornarString(detalleCompra.getCabecera().getFecha());
                this.jLabelFecha.setText(fecha);
                this.jLabelVenta.setText(String.valueOf(detalleCompra.getCabecera().getNFactura()));
                this.jLabelTotal.setText(String.valueOf( new java.text.DecimalFormat("Q #,##0.00").format(Double.valueOf(detalleCompra.getCabecera().getTotal()))));
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Vea el detalle de medicamentos por compra. . .");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabelVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pDetalleCompra dialog = new pDetalleCompra(new javax.swing.JFrame(), true);
